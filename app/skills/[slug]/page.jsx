...
const skillData = {
  ...
  'hubspot': {
    ...
    features: ['Search and create contacts', 'Manage companies', 'Track deals through pipeline stages', 'Log notes and activities', 'Associate records (contacts ↔ companies ↔ deals)', 'Search across all CRM objects', 'View sales pipelines', 'Zero dependencies — pure Node.js'],
