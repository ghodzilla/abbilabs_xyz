...
const templates = [
  ...
  },
  {
    ...
    price: 99,
    badge: 'New',
    tagline: 'Handle 70% of support tickets autonomously.',
    description: 'Triages every incoming ticket, auto-responds from your knowledge base, and escalates to Slack with full context. Works with email (IMAP/SMTP) or Intercom. Detects sentiment, handles multi-language, and blocks social engineering attempts.',
    includes: [
      '4-category triage engine (auto-resolve, needs context, escalate, urgent)',
      'Knowledge base search (Markdown + Notion)',
      'Auto-response from KB with personalisation',
      'Slack escalation with full context + sentiment',
      'Daily + weekly metrics reports',
      'Email adapter (Gmail, Outlook, any IMAP)',
      'Intercom adapter (read, reply, tag, close)',
      'Google Sheets ticket logging',
      'Multi-language support (auto-detect)',
      'Security: social engineering detection',
    ],
    tools: ['Email (IMAP)', 'Intercom', 'Slack', 'Notion', 'Google Sheets'],
