...
const skillData = {
  ...
  'slack': {
    ...
    longDescription: 'Your agent posts messages, reads channels, manages threads, searches conversations, and automates team communication.',
    features: ['Send messages to channels and DMs', 'Read channel history', 'Manage threads and replies', 'React to messages', 'Pin/unpin messages', 'Search conversations'],
    useCases: ['Daily standup bot', 'Alert system', 'Customer support', 'Meeting recaps', 'Team updates'],
    setupTime: '5 minutes',
  ...
  'notion': {
    ...
    longDescription: 'Create pages, query databases, update content, search your entire workspace. Your agent becomes a Notion power user.',
    features: ['Search pages and databases', 'Create pages with formatting', 'Query databases with filters', 'Create database entries', 'Update page properties', 'Automatic markdown conversion'],
    useCases: ['Knowledge base management', 'Task database', 'CRM management', 'Content calendar', 'Meeting notes'],
    setupTime: '5 minutes',
  ...
  'stripe': {
    ...
    longDescription: 'Track revenue, manage subscriptions, process refunds, create invoices. Your agent becomes your financial operator.',
    features: ['Search customers and payments', 'Create and manage subscriptions', 'Process refunds', 'Create and send invoices', 'Manage products and pricing', 'Revenue reporting'],
    useCases: ['Daily revenue tracking', 'Subscription management', 'Refund handling', 'Invoice automation', 'Financial reporting'],
    setupTime: '5 minutes',
